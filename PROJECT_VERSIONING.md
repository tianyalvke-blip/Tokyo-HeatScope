...
|---|---|---|
| Project | Runnable release composition and deployment record | `project-v1.2.3` |
| App | Map workspace, tool runtime and data loading | `app-v1.2.1` |
| UI | Presentation and interaction | `ui-v1.2.2` |
| Agent | Prompt, routing, tool policy and evidence constraints | `agent-v1.2.2` |
...
| Homepage performance patch | v1.2.2 | `project-v1.2.2` | WebP homepage imagery and below-the-fold lazy loading; App and Agent remain v1.2.1. |
| Counterfactual default policy | v1.2.3 | `project-v1.2.3` | Agent v1.2.2 defaults an unspecified scenario magnitude to a trusted feature-response curve instead of repeatedly asking for a numeric value. |
