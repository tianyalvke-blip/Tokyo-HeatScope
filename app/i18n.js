...
const STRINGS = {
    en: {
        ...
        welcome: [
            ...
            '',
            'A natural language\u2013driven platform for urban heat analysis and planning. Explore daytime and nighttime land surface temperature (LST) across Tokyo\u2019s 23 wards on a 200 m grid, supported by spatial analysis tools, an urban morphology\u2013LST Random Forest (RF) model, and a planning policy RAG knowledge base. The platform supports heat pattern detection, spatial statistics, causal interpretation, area comparison, scenario simulation, and planning recommendations.',
            '',
            'Try asking:',
        ].join('\n'),
        examples: [
    ...
    ja: {
        ...
        welcome: [
            '地図と対話し、都市の暑熱環境を読み解く',
            '',
            '自然言語で操作できる都市暑熱環境分析・計画支援プラットフォームです。200 m グリッドを基盤として、東京23区の昼間・夜間の地表面温度（LST）を分析し、空間分析ツール、都市形態―LST ランダムフォレスト（RF）モデル、および都市計画・政策文書の RAG ナレッジベースを組み合わせて分析を行います。暑熱分布の把握、空間統計、要因分析、地域比較、シナリオシミュレーション、計画施策の提案に対応します。',
            '',
            '例えば、次のように質問できます：',
        ].join('\n'),
        examples: [
    ...
    zh: {
        ...
        welcome: [
            '与地图对话，读懂城市热环境',
            '',
            '自然语言驱动的城市热环境规划智能平台。基于 200 m 网格探索东京 23 区昼夜地表温度（LST），结合空间分析工具、城市形态—LST 随机森林（RF）模型与规划政策 RAG 知识库，支持热环境识别、空间统计、成因诊断、区域比较、情景模拟与规划决策。',
            '',
            '你可以试着问：',
        ].join('\n'),
        examples: [
