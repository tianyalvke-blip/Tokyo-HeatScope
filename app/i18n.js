...
const STRINGS = {
    en: {
        ...
        examples: [
            'Where are the major heat clusters in Urban?',
            'Compare the thermal environments of Shinjuku and Marunouchi.',
            'Calculate the day\u2013night LST difference across Urban.',
            ...
            'Based on Urban\u2019s planning policies and design guidelines, which cooling strategies should Bancho prioritize?',
        ],
    },
    ja: {
        ...
        examples: [
            ...
            '都市の都市計画政策や設計ガイドラインに基づき、番町ではどのような暑熱緩和策を優先すべきですか？',
        ],
    },
    zh: {
        brandTitle: '城市热洞察',
