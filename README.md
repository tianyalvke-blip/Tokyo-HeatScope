...
- 版本管理：[`PROJECT_VERSIONING.md`](PROJECT_VERSIONING.md)（组合发布）、[`APP_VERSIONING.md`](APP_VERSIONING.md)（运行时/工具层）、[`UI_VERSIONING.md`](UI_VERSIONING.md)（视觉层）、[`AGENT_VERSIONING.md`](AGENT_VERSIONING.md)（Agent 行为层）。
